...
App.prototype.post = function(url, data){
	...
	// var promise = curried(object);
		...
		url = arguments[0];
		var curried = function(data){
			return this.post(url, data);
		}.bind(this);
		// extend Writable interface.
		var Dummy = function(){};
		Dummy.prototype = curried;
		util.inherits(Dummy, Writable);
		Writable.call(curried, {objectMode: true, write: curried});
		return curried;
	}
	// Invalid arguments.
	...
	var reqestOptions = _.defaults({method: 'post'}, urlObj);
